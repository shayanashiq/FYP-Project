        ...
        <footer className="bg-[#205781] text-white py-8 md:py-16 mt-12">
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8">
                    {/* Brand Column */}
                    <div className="space-y-4 lg:w-1/3 mb-8 lg:mb-0">
                        <h2 className="text-2xl md:text-3xl font-bold italic">Lylla & Lora</h2>
                        <p className="text-base md:text-lg w-full md:w-4/5 lg:w-2/3">
                        ...
                        <div className="flex space-x-3 pt-2">
                            ...
                            <a href="#" className="bg-gray-700 p-2 rounded-full hover:bg-gray-800 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="white">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 lg:gap-12 lg:w-2/3">
                        {/* Company Column */}
                        <div>
