  ...
  return (
    <div className="container mx-auto">
      <div className="flex p-10">
        <div className="w-[93%] h-40 bg-sky-100 rounded-2xl justify-center items-center gap-20 flex m-auto">
          <div className="justify-start items-center gap-8 flex">
            ...
            <div className="flex-col justify-center items-start gap-1.5 inline-flex">
              <div className="text-sky-900 text-2xl font-semibold">
                Free delivery
              </div>
              <div className="text-sky-900 text-lg font-normal">
                on order above £70
              </div>
            </div>
          </div>
          ...
          <div className="justify-start items-center gap-8 flex">
            <div className="w-16 h-16 justify-center items-center flex">
              <div className="w-16 h-16 relative">
                ...
                >
                  <path
                    d="M33.5 4C17.536 4 4 17.536 4 33.5C4 49.464 17.536 63 33.5 63C49.464 63 63 49.464 63 33.5C63 17.536 49.464 4 33.5 4ZM33.5 58C19.561 58 8 46.439 8 33.5C8 20.561 19.561 9 33.5 9C47.439 9 59 20.561 59 33.5C59 46.439 47.439 58 33.5 58ZM48 32C48 25.3726 42.6274 20 36 20H32C25.3726 20 20 25.3726 20 32V37C20 40.3137 22.6863 43 26 43H28C28 44.6569 29.3431 46 31 46H37C38.6569 46 40 44.6569 40 43H42C45.3137 43 48 40.3137 48 37V32ZM24 32C24 27.5817 27.5817 24 32 24H36C40.4183 24 44 27.5817 44 32V37C44 38.6569 42.6569 40 41 40H26C24.3431 40 23 38.6569 23 37V32H24ZM33.5 47C32.1193 47 31 48.1193 31 49.5C31 50.8807 32.1193 52 33.5 52C34.8807 52 36 50.8807 36 49.5C36 48.1193 34.8807 47 33.5 47Z"
                    fill="#EDA415"
                  />
                </svg>
              </div>
